...
class Trainer(object):
    ...
    def train(self):
        ...
        for epoch in range(self.start_epoch, self.epochs):
            ...
            self.write.add_scalar("train loss", tr_loss, epoch + 1)  # 写入损失
    ...
    def _run_one_epoch(self, epoch, cross_valid=False):
        ...
        for i, (data) in enumerate(data_loader):
            # torch.Size([1, 32000]), tensor([32000], dtype=torch.int32), torch.Size([1, 2, 32000])
            ...
            loss, _, _, _ = cal_loss(padded_source, estimate_source, mixture_lengths)
